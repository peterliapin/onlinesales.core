...
namespace OnlineSales.Infrastructure
{
        ...
        where T : BaseEntityWithId
    {
        ...
        public MixedQueryProvider(QueryParseData<T> parseData, IQueryable<T> query, ElasticClient elasticClient, string indexPrefix/*, PgDbContext dbContext*/)
        {
        ...
        {
            var selectData = new QueryParseData<T>.SelectCommandData();
            ...
            var idSelectData = new QueryParseData<T>.SelectCommandData() { SelectedProperties = new List<PropertyInfo> { typeof(T).GetProperty("Id") ! }, IsSelect = true };
