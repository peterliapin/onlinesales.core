...
namespace OnlineSales.Migrations
{
    ...
    [Migration("20230802091745_ContactIpAdded")]
    partial class ContactIpAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineSales.Entities.ContactIp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_contact_ip");

                    b.HasIndex("ContactId")
                        .HasDatabaseName("ix_contact_ip_contact_id");

                    b.ToTable("contact_ip", (string)null);
                });
            ...
            modelBuilder.Entity("OnlineSales.Entities.ContactIp", b =>
                {
                    b.HasOne("OnlineSales.Entities.Contact", "Contact")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contact_ip_contact_contact_id");
